...
export default function AccountPage() {
  ...
  return (
    <div className="container-app py-6 animate-fade-in">
      <div className="mb-6"><h1 className="text-2xl md:text-3xl font-bold text-[#1e293b]">💎 我的账户</h1></div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          <div className="card p-6 mb-4 border-[#bbf7d0] bg-[#f0fdf4]"><h3 className="font-semibold text-sm text-[#166534]">🆓 免费版 {(!user || user.membership_level === "free") ? "(当前)" : ""}</h3><p className="text-2xl font-bold text-[#166534] my-2">免费</p><ul className="text-xs space-y-1.5 text-[#166534]"><li>✓ 每日{usage ? usage.daily_limit : 10}次生成</li><li>✓ 基础任务</li><li>✓ 单版本生成</li><li>✓ 基础风险提醒</li><li>✓ 复制文本</li></ul></div>
          <div className="card p-6 mb-4 border-[#bfdbfe]"><h3 className="font-semibold text-sm">🌟 个人专业版 {user?.membership_level === "pro" ? "(当前)" : ""}</h3><p className="text-2xl font-bold my-2">69 <span className="text-sm font-normal text-[#64748b]">元/月</span></p><ul className="text-xs space-y-1.5 text-[#475569]"><li>✓ 每日50次生成</li><li>多版本(限20次/日)</li><li>✓ Word/PDF导出</li><li>✓ 常用活动模板</li><li>✓ 多版本生成</li><li>✓ 风险检查</li></ul><button className="btn-primary w-full mt-4 text-sm" disabled>即将上线</button></div>
          <div className="card p-6 border-[#ddd6fe]"><h3 className="font-semibold text-sm">🚀 材料达人版 {user?.membership_level === "expert" ? "(当前)" : ""}</h3><p className="text-2xl font-bold my-2">299 <span className="text-sm font-normal text-[#64748b]">元/月</span></p><ul className="text-xs space-y-1.5 text-[#475569]"><li>✓ 每日200次生成</li><li>多版本(限50次/日)</li><li>✓ 多模型比选</li><li>✓ 完整材料包</li><li>✓ 版本融合</li><li>✓ 高级风控报告</li></ul><button className="btn-primary w-full mt-4 text-sm" disabled>即将上线</button></div>
