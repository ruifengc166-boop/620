    ...
    <footer className="hidden md:block bg-white border-t border-[#e2e8f0] py-6 mt-auto">
      <div className="container-app">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          <div><h3 className="font-semibold text-sm mb-2">办会助理</h3><p className="text-xs text-[#64748b]">{t("footer_tagline","少加班，快交稿，材料不出错")}</p><p className="text-xs text-[#64748b] mt-1">{t("footer_tagline","少加班，快交稿，材料不出错")}</p></div>
